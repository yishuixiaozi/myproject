...
<form class="form-horizontal" role="form" action="/employee/updateemployee.action" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="lastname" name="cardid"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="lastname1" name="address"
                   placeholder="请输入住址" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="lastname3" name="education"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="lastname4" name="phone"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="lastname5" name="email"
...
<script type="text/javascript">
    ...
    document.getElementById("lastname").value = cardid;
    document.getElementById("lastname1").value = address;
    document.getElementById("lastname2").value = id;
    document.getElementById("lastname3").value = education;
    document.getElementById("lastname4").value = phone;
    document.getElementById("lastname5").value = email;
</script>
</body>
</html>